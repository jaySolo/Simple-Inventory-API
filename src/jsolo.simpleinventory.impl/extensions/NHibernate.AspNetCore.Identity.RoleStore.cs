...
namespace NHibernate.AspNetCore.Identity
{
    ...
    {
        public RoleStore(ISession session, IdentityErrorDescriber describer = null)
            ...
            where TRoleClaim : IdentityRoleClaim<TKey>, new()
    {
        ...
        public RoleStore(ISession session, IdentityErrorDescriber describer = null)
            : base(describer) => this.session = session ?? throw new ArgumentNullException(nameof(session));
        ...
        private IQueryable<TRoleClaim> RoleClaims => session.Query<TRoleClaim>();
